...
class Settings:
    ...
    # SMTP & Email Verification Settings (Gmail / Custom SMTP)
    SMTP_HOST: str = os.getenv("SMTP_HOST", "smtp.gmail.com")
    SMTP_PORT: int = int(os.getenv("SMTP_PORT", "587"))
    SMTP_USER: str = os.getenv("SMTP_USER", "adityaraj15spj@gmail.com")
    SMTP_PASSWORD: str = os.getenv("SMTP_PASSWORD", "")
    SMTP_FROM_EMAIL: str = os.getenv("SMTP_FROM_EMAIL", "adityaraj15spj@gmail.com")
    SMTP_FROM_NAME: str = os.getenv("SMTP_FROM_NAME", "NITK File Converter System")
